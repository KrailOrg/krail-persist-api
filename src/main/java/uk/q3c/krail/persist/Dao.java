...
public interface Dao<ID, VER> {
     ...
     *
     * @param entityClass the class of the entity, used to identify
     * @param <E>         the type of the entity
    ...
    /**
     * @param entityClass class of the entity to return, which will be translated into the table name
     * @param <E>         the type of the entity
     ...
     *
     * @param entity the entity for which the version is required
     * @param <E>    the type of the entity
     ...
     *
     * @param entityClass the entity class to be counted
     * @param <E>
